...
```sh
sha256sum -c ethernet-gateway-v0.6.0-x86_64-unknown-linux-gnu.tar.gz.sha256
```
...
gpg --verify \
    ethernet-gateway-v0.6.0-x86_64-unknown-linux-gnu.tar.gz.asc \
    ethernet-gateway-v0.6.0-x86_64-unknown-linux-gnu.tar.gz
```
...
```sh
cosign verify-blob \
    --certificate ethernet-gateway-v0.6.0-x86_64-unknown-linux-gnu.tar.gz.pem \
    --signature   ethernet-gateway-v0.6.0-x86_64-unknown-linux-gnu.tar.gz.sig \
